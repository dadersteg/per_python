...
def run_master_audit():
    ...
    try:
        ...
        # Optimized categorization using vectorized operations (faster than apply)
        conditions = [
        ...
        df_spine['reconciliation_outcome'] = np.select(conditions, choices, default="REGISTER_ONLY (Unmapped Product)")
